...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2025 at 02:32 PM
...
--
DROP TRIGGER IF EXISTS `calculate_total_price_trigger`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `calculate_total_price_update_trigger`;
DELIMITER $$
...
--
-- Indexes for table `inventory_view`
--
...
--
-- AUTO_INCREMENT for table `inventory_view`
--
ALTER TABLE `inventory_view`
